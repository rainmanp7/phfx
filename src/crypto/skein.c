...
#define SKEIN_BLK_TYPE_PK       (12)                    /* public key (for phfire signature hashing) */
...
#define SKEIN_T1_BLK_TYPE_PK    SKEIN_T1_BLK_TYPE(PK)   /* public key (for phfire signature hashing) */
